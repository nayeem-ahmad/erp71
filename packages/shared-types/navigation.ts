...
export const DEFAULT_TENANT_NAV_LAYOUT: NavLayoutNode[] = [
  ...
  layoutNode('account-settings.billing', 'account-settings', 13),
  layoutNode('account-settings.sms-credits', 'account-settings', 14),
  layoutNode('account-settings.ai-credits', 'account-settings', 15),
