...
export const DEFAULT_TENANT_NAV_LAYOUT: NavLayoutNode[] = [
  ...
  layoutNode('hr.organization.designations', 'hr', 3),
  ...
  layoutNode('hr.recruitment.job-posts', 'hr', 8),
  layoutNode('hr.recruitment.applicants', 'hr', 9),
  layoutNode('hr.recruitment.applications', 'hr', 10),
