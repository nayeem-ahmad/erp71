...
export const NAV_REGISTRY: Record<string, NavRegistryEntry> = {
  ...
  'admin.tenant-management.payments': { id: 'admin.tenant-management.payments', kind: 'link', icon: 'Wallet', labelKey: 'sidebar.items.tenantPayments', href: '/admin/tenants/payments' },
...
export const DEFAULT_TENANT_NAV_LAYOUT: NavLayoutNode[] = [
  ...
  layoutNode('admin.tenant-management.payments', 'admin.tenant-management', 1),
...
export const DEFAULT_PLATFORM_ADMIN_NAV_LAYOUT: NavLayoutNode[] = [
  ...
  layoutNode('admin.feedback', 'admin', 3),
  layoutNode('admin.support', 'admin', 4),
  layoutNode('admin.system-health', 'admin', 5),
  layoutNode('admin.status', 'admin', 6),
