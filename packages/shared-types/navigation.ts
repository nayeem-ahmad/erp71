...
export const DEFAULT_TENANT_NAV_LAYOUT: NavLayoutNode[] = [
  ...
  layoutNode('inventory.transfers', 'inventory', 1),
  layoutNode('inventory.stock-takes', 'inventory', 2),
  layoutNode('inventory.shrinkage', 'inventory', 3),
  layoutNode('inventory.reports', 'inventory', 4),
  ...
  layoutNode('inventory.labels', 'inventory.reports', 4),
  layoutNode('inventory.setup', 'inventory', 5),
