...
export const JOB_REGISTRY: JobDefinition[] = [
    ...
    { name: JOB_NAMES.CRM_REORDER_FOLLOWUPS, label: 'CRM: reorder reminder follow-ups', schedule: '0 8 * * *', maxIntervalMs: DAY + 2 * HOUR },
    { name: JOB_NAMES.CRM_BIRTHDAY_FOLLOWUPS, label: 'CRM: birthday follow-ups', schedule: '0 8 * * *', maxIntervalMs: DAY + 2 * HOUR },
