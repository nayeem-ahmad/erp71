...
type AccountingToolbarProps = {
    /** Optional help text — title comes from the app header */
    help?: string;
    /** Brief context line below actions row */
    subtitle?: string;
    actions?: ReactNode;
    children?: ReactNode;
};
...
/**
 * Slim action bar for accounting pages. Page title is shown in the app header only.
 */
