...
export const STATE_STYLES: Record<DependencyState, { dot: string; chip: string }> = {
                ...
                <>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div className="rounded-3xl border border-gray-100 bg-white p-6">
                            ...
                            <p className="mt-1 text-xs text-gray-400">{m.table.latency}: {report.duration_ms}ms</p>
                        </div>
                    </div>
                                    ...
                                    {jobs.map((job) => (
                                        <tr key={job.name}>
                                            ...
                                            <td className="py-2">
                                                ...
                                                {job.last_error && (
                                                    <p className="mt-1 max-w-xs truncate text-[10px] text-red-500" title={job.last_error}>
                                                        {job.last_error}
                                                    </p>
                                                )}
                                            </td>
