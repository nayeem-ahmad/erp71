...
function renderHelp(features?: { help?: boolean }) {
    return render(
        <PlatformFeaturesProvider features={{ feedback: false, support: false, help: true, voice: false, manufacturing: true, aiChat: false, externalImport: false, projects: false, platformProjects: false, platformAccounting: false, ...features }}>
