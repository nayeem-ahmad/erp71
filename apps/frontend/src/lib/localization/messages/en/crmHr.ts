export const crmHrMessages = {
    crm: {
        ...
        leadTaxonomy: {
            title: 'Lead Sources & Categories',
            subtitle: 'The lists your team picks from when classifying a lead.',
            tabs: { sources: 'Sources', categories: 'Categories' },
            ...
            edit: 'Edit',
            activate: 'Show again',
            deactivate: 'Hide from new leads',
            saved: 'Saved.',
            ...
            delete: {
                ...
                reassignLabel: 'Move those leads to',
