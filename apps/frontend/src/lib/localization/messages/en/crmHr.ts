export const crmHrMessages = {
    crm: {
        ...
        activities: {
            ...
            edit: 'Edit',
            editTitle: 'Edit planned activity',
            editRollupHint: 'This is the lead\'s next step while it is the earliest one planned.',
            cancelled: 'Cancelled',
            scheduleNext: 'Schedule the next one',
            inheritsHint: 'Inherits the purpose of the activity you are closing.',
            due: 'Due',
            noDate: 'No date set',
            overdue: 'Overdue',
            ...
            fields: {
                ...
                targetPlaceholder: 'Search by name or phone',
                targetHint: 'Type at least 2 characters.',
                targetNoResults: 'No lead or customer matches that.',
                targetChange: 'Change',
                lead: 'Lead',
                customer: 'Customer',
                template: 'Message template',
                templateHint: 'Fills the fields below — edit before saving.',
        ...
        setup: {
            ...
            descriptions: {
                ...
                templates: 'Reusable messages your team drops into a logged or scheduled activity.',
        ...
        messageTemplates: {
            ...
            edit: 'Edit',
            activate: 'Show again',
            deactivate: 'Hide from the picker',
            ...
            fields: {
                name: 'Template name',
                namePlaceholder: 'Payment reminder',
                usage: 'Offer it in',
                usageHint: 'Which dialog this template shows up in.',
                channel: 'Channel',
                channelHint: 'Offer it only on this channel. Leave blank for every channel.',
                anyChannel: 'Any channel',
                purpose: 'Purpose',
                purposeHint: 'Pre-selected when the template is used to schedule.',
                noPurpose: 'No purpose',
                subject: 'Subject',
                subjectHint: 'Fills "What needs doing". Left blank, the template name is used.',
                subjectPlaceholder: 'Remind about the outstanding invoice',
                body: 'Message',
                bodyPlaceholder: 'Dear {{name}}, your invoice is still outstanding. — {{user}}, {{business}}',
            },
            validation: {
            ...
            delete: {
                ...
                action: 'Delete',
                body: 'Delete "{name}"?',
                note: 'Activities already logged from it keep their text.',
                done: 'Template deleted.',
                failed: 'Could not delete the template.',
            },
        },
        leadTaxonomy: {
        ...
        leads: {
            ...
            noActivityFilter: 'No activity in {days} days',
            noActivityEmpty: 'No leads have gone {days} days without activity.',
            statuses: {
                NEW: 'New',
                CONTACTED: 'Contacted',
                QUALIFIED: 'Qualified',
