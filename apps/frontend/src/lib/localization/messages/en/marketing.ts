export const marketingMessages = {
    home: {
        ...
        features: {
            ...
            items: [
                ...
                { title: 'Inventory Control', desc: 'Multi-warehouse stock tracking, reorder alerts, and full movement history.' },
    ...
    contact: {
        ...
        subjects: ['General Inquiry', 'Sales', 'Technical Support', 'Billing', 'Partnership'],
    },
    status: {
        title: 'System Status',
