export const projectsMessages = {
    ...
    epics: {
        ...
        add: "Epik baharu",
        edit: "Sunting epik",
        empty: "Belum ada epik. Kumpulkan cerita pengguna yang berkaitan di bawah satu epik untuk menjejak skop yang lebih besar.",
        code: "ID epik",
        codeHint: "Biarkan kosong untuk penomboran automatik, cth. {example}.",
        codeAuto: "Automatik",
        codeRequired: "Beri epik ini satu ID.",
        codeNoSpaces: "ID epik tidak boleh mengandungi ruang.",
        projectRequired: "Pilih projek.",
        pickProject: "Pilih projek",
        description: "Penerangan",
        descriptionPlaceholder: "Apa yang dihasilkan oleh kerja ini, dan mengapa ia penting.",
        color: "Warna",
        startDate: "Tarikh mula",
        targetDate: "Tarikh sasaran",
        statuses: {
        ...
        storyProgress: "{done}/{total} cerita",
        pointsProgress: "{done}/{total} mata",
        taskProgress: "{done}/{total} tugasan",
        noStories: "Belum ada cerita di bawah epik ini.",
        addStory: "Tambah cerita",
        storyPlaceholder: "Tajuk cerita dalam epik ini",
        field: "Epik",
        none: "Tiada epik",
        created: "Epik dicipta",
        updated: "Epik disimpan",
        deleted: "Epik dipadam",
        deleteEpic: "Padam epik",
        deletePrompt: "Padam {title}?\n\nCerita di bawahnya dikekalkan — hanya kumpulannya yang hilang.",
        saveFailed: "Tidak dapat menyimpan epik",
    ...
    epicList: {
        title: "Epik",
        subtitle: "Setiap epik merentas semua projek",
        empty: "Belum ada epik. Tulis satu, atau import daripada hamparan.",
        emptyFiltered: "Tiada epik sepadan dengan penapis ini.",
        searchPlaceholder: "Cari ID atau tajuk epik",
        allProjects: "Semua projek",
        anyStatus: "Mana-mana status",
        anyPriority: "Mana-mana keutamaan",
        epic: "Epik",
        progress: "Kemajuan",
        stories: "Cerita",
        openInProject: "Buka dalam projeknya",
    ...
    task: {
        ...
        copyLinkFailed: 'Tidak dapat menyalin pautan',
    ...
    board: {
        ...
        laneCards: '{count} kad',
        laneDone: '{done}/{count} selesai',
        laneCollapse: 'Lipat lorong',
        laneExpand: 'Kembangkan lorong',
        laneOtherProject: 'Cerita itu milik projek lain, jadi kad ini tidak boleh menyertainya',
        laneColumn: 'Lajur',
    ...
    sprint: {
        ...
        emptyStories: "Tiada cerita pengguna terbuka.",
        openTasks: "{count} tugas terbuka",
        storyHint: "Menambah setiap tugas terbuka di bawah cerita yang dipilih yang belum berada dalam sprint.",
        selectedHours: "{count} dipilih · {hours}j",
        tasksAdded: "{count} tugas ditambah ke sprint",
        nothingAdded: "Cerita tersebut tiada tugas terbuka di luar sprint.",
        removed: "Dikembalikan ke tunggakan",
        colTask: "Tugas",
        colEstimate: "Anggaran (j)",
        ...
        statDaysLeft: "Hari bekerja berbaki",
        statVariance: "Berbanding ideal",
