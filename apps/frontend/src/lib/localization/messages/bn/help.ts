    ...
    sections: {
        gettingStarted: {
            ...
            faqs: [
                ...
                },
                {
                    ...
                    a: "সেলফ-সার্ভ পেইড প্ল্যানগুলো হলো BASIC (Starter), ACCOUNTING, STANDARD (Growth) এবং PREMIUM (Business) — Business-এ পেরোল, ম্যানুফ্যাকচারিং, ইমপোর্ট ও API অ্যাক্সেস যুক্ত হয় এবং এতে এককালীন সেটআপ ফি রয়েছে। Enterprise কোট-ভিত্তিক: চেকআউট নয়, সেলসের সঙ্গে যোগাযোগ করুন। পুরনো Free প্ল্যান নতুন সাইন-আপের জন্য আর দেওয়া হয় না। Billing-এ যেকোনো সময় প্ল্যান তুলনা করে পরিবর্তন করতে পারেন।",
                },
            ],
        },
        pos: {
        ...
        aiAssistant: {
            ...
            faqs: [
                ...
                {
                    q: 'টাইপ না করে প্রশ্ন বলা যায়?',
                    a: 'হ্যাঁ — ব্রাউজার সাপোর্ট করলে (HTTPS-এ Chrome, Edge বা Safari) Send-এর পাশে একটি মাইক্রোফোন দেখা যায়। ট্যাপ করে প্রশ্ন বলুন, প্রয়োজনে লেখা সম্পাদনা করুন, তারপর পাঠান। সহকারী এখনও উত্তর জোরে পড়ে শোনায় না।',
                },
            ],
        },
        billing: {
