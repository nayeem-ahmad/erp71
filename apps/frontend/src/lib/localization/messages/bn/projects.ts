export const projectsMessages = {
    ...
    sprint: {
        ...
        emptyStories: "কোনো খোলা ইউজার স্টোরি নেই।",
        openTasks: "{count}টি খোলা টাস্ক",
        storyHint: "নির্বাচিত স্টোরির অধীনে যে খোলা টাস্কগুলো এখনও কোনো স্প্রিন্টে নেই, সেগুলো যোগ করে।",
        selectedHours: "{count}টি নির্বাচিত · {hours} ঘণ্টা",
        tasksAdded: "স্প্রিন্টে {count}টি টাস্ক যোগ হয়েছে",
        nothingAdded: "ওই স্টোরিগুলোর স্প্রিন্টের বাইরে কোনো খোলা টাস্ক নেই।",
        removed: "ব্যাকলগে ফেরত পাঠানো হয়েছে",
        colTask: "টাস্ক",
        colEstimate: "আনুমানিক (ঘ)",
        colSpent: "ব্যয়িত (ঘ)",
        colRemaining: "বাকি (ঘ)",
        total: "মোট",
        ...
        statDaysLeft: "বাকি কর্মদিবস",
        statVariance: "আদর্শের তুলনায়",
