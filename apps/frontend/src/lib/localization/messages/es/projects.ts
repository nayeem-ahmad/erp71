export const projectsMessages = {
    ...
    storyList: {
        ...
        anyPriority: "Cualquier prioridad",
        story: "Historia",
        openInProject: "Abrir en su proyecto",
        anyEpic: "Cualquier épica",
        noEpic: "Sin épica",
    },
    ...
    epics: {
        ...
        add: "Nueva épica",
        edit: "Editar épica",
        empty: "Aún no hay épicas. Agrupa historias de usuario relacionadas en una para seguir un alcance mayor.",
        code: "ID de épica",
        codeHint: "Déjalo en blanco para numerarla automáticamente, p. ej. {example}.",
        codeAuto: "Automático",
        codeRequired: "Asigna un ID a la épica.",
        codeNoSpaces: "Un ID de épica no puede contener espacios.",
        projectRequired: "Elige un proyecto.",
        pickProject: "Elige un proyecto",
        description: "Descripción",
        descriptionPlaceholder: "Qué entrega este bloque de trabajo y por qué importa.",
        color: "Color",
        startDate: "Fecha de inicio",
        targetDate: "Fecha objetivo",
        statuses: {
        ...
        storyProgress: "{done}/{total} historias",
        pointsProgress: "{done}/{total} pts",
        taskProgress: "{done}/{total} tareas",
        noStories: "Aún no hay historias en esta épica.",
        addStory: "Añadir historia",
        storyPlaceholder: "Título de una historia de esta épica",
        field: "Épica",
        none: "Sin épica",
        created: "Épica creada",
        updated: "Épica guardada",
        deleted: "Épica eliminada",
        deleteEpic: "Eliminar épica",
        deletePrompt: "¿Eliminar {title}?\n\nSus historias se conservan; solo pierden la agrupación.",
        saveFailed: "No se pudo guardar la épica",
    ...
    epicList: {
        title: "Épicas",
        subtitle: "Todas las épicas de todos los proyectos",
        empty: "Aún no hay épicas. Crea una o impórtalas desde una hoja de cálculo.",
        emptyFiltered: "Ninguna épica coincide con estos filtros.",
        searchPlaceholder: "Busca un ID o título de épica",
        allProjects: "Todos los proyectos",
        anyStatus: "Cualquier estado",
        anyPriority: "Cualquier prioridad",
        epic: "Épica",
    ...
    hourLogs: {
        ...
        trackerNoTasks: "No tiene tareas asignadas.",
        trackerNoMatches: "Ninguna tarea coincide con esa búsqueda.",
        clearTask: "Quitar la tarea seleccionada",
        scope: "Qué tareas mostrar",
        scopeMine: "Mías",
        scopeEveryone: "Todos",
        ...
        tracker: 'Registro de tiempo',
        trackerMove: 'Mover el registro de tiempo',
        trackerCollapse: 'Contraer el registro de tiempo',
        trackerExpand: 'Expandir el registro de tiempo',
        trackerClose: 'Ocultar el registro de tiempo',
    ...
    board: {
        ...
        laneUnassigned: "Sin asignar",
        laneNoStory: "Sin historia de usuario",
        laneCards: "{count} tarjetas",
        laneDone: "{done}/{count} hechas",
        laneCollapse: "Contraer carril",
        laneExpand: "Expandir carril",
        laneOtherProject: "Esa historia pertenece a otro proyecto, así que esta tarjeta no puede unirse a ella",
        laneColumn: "Columna",
        ...
        view: {
            title: "Apariencia",
            scopeHint: "Solo para usted, en este navegador: los demás ven el tablero a su manera.",
            reset: "Restablecer",
            ...
            scrollPage: "Toda la página",
            scrollColumn: "Dentro de las columnas",
            scrollHint: "Dentro de las columnas mantiene fijos el encabezado del tablero y el título de cada columna. En el móvil se desplaza la página en ambos casos.",
            swimlanes: "Carriles",
            swimlanesNone: "Ninguno",
            swimlanesAssignee: "Responsable",
            swimlanesStory: "Historia de usuario",
            swimlanesHint: "Divide cada columna en una fila por persona o historia. Las tarjetas se mueven entre columnas dentro de su propia fila.",
            motion: "Animaciones",
    ...
    sprint: {
        ...
        emptyStories: "No hay historias de usuario abiertas.",
        openTasks: "{count} tarea(s) abierta(s)",
        storyHint: "Añade cada tarea abierta de las historias seleccionadas que aún no esté en un sprint.",
        selectedHours: "{count} seleccionadas · {hours} h",
        tasksAdded: "{count} tarea(s) añadida(s) al sprint",
        nothingAdded: "Esas historias no tienen tareas abiertas fuera de un sprint.",
        removed: "Devuelta al backlog",
        colTask: "Tarea",
        colEstimate: "Estimación (h)",
        colSpent: "Dedicado (h)",
        ...
        statDaysLeft: "Días laborables restantes",
        statVariance: "Frente al ideal",
    ...
    boards: {
        ...
        loadAll: "Cargar todo",
        allOnBoard: "Todas las tareas coincidentes ya están en este tablero.",
        loadMore: "Cargar más",
        ...
        moveColumnUp: "Subir",
        moveColumnDown: "Bajar",

        searchCards: "Buscar tarjetas",
        dragColumn: "Arrastre para reordenar",
        columnActions: "Acciones de la columna",
        renameColumn: "Cambiar el nombre",
        moveColumnLeft: "Mover a la izquierda",
        moveColumnRight: "Mover a la derecha",
        sortCards: "Ordenar tarjetas",
        sortBy: {
        ...
        moveAllCards: "Mover todas las tarjetas a",
        selectAllCards: "Seleccionar todas las tarjetas",
        noOtherColumn: "Todavía no hay otra columna",
        selectCard: "Seleccionar la tarjeta",
        moveSelectedTo: "Mover la selección a…",
        clearSelection: "Quitar la selección",
        columnAdded: "Columna añadida",
        columnRenamed: "Columna renombrada",
        columnsReordered: "Orden de columnas guardado",
        cardsSorted: "Tarjetas ordenadas",
        cardsMoved: "{count} tarjeta(s) movida(s)",
        cardsRemoved: "{count} tarjeta(s) quitada(s)",
        removeTitle: "¿Quitar esta tarjeta?",
        removeTitleMany: "¿Quitar {count} tarjetas?",
        removeFromBoardHint: "Solo quitarla de este tablero. La tarea sigue en su proyecto y en otros tableros.",
        deleteTasks: "Eliminar tarea(s)",
        deleteTasksHint: "Eliminar la tarea en sí. Desaparece de su proyecto y de todos los tableros.",
        tasksDeleted: "{count} tarea(s) eliminada(s)",
        tasksDeleteFailed: "{count} tarea(s) no se pudieron eliminar",
