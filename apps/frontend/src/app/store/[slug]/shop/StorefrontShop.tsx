...
export default function StorefrontShop({ slug }: { slug: string }) {
    const { t, fmt } = useI18n();
    ...
    return (
        <div
            ...
            style={storefrontThemeStyle(storefrontTheme(data.tenant.brand_primary_color))}
        >
                        ...
                        {cart.length > 0 && (
                            <div className="p-6 bg-gray-50 border-t border-gray-100 space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full bg-[color:var(--sf-accent)] text-[color:var(--sf-accent-foreground)] font-bold py-4 rounded-xl transition-opacity hover:opacity-90 shadow-lg shadow-black/10"
                                >
                                    {m.proceedToCheckout}
                                </button>
                            </div>
