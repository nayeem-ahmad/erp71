...
export const metadata = {
    title: 'Refund & Cancellation Policy — RetailSaaS',
    description: 'Refund and cancellation policy for RetailSaaS subscriptions',
};
        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <main className="pt-28 pb-24 px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <h1 className="text-4xl font-black tracking-tight text-gray-900 mb-2">Refund &amp; Cancellation Policy</h1>
