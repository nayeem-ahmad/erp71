...
export const metadata: Metadata = {
    title: 'Contact — ERP71',
    description: 'Get in touch with the ERP71 team about pricing, onboarding or support.',
    alternates: { canonical: `${process.env.NEXT_PUBLIC_SITE_URL ?? 'https://app.erp71.com'}/contact` },
    openGraph: {
        title: 'Contact — ERP71',
        description: 'Get in touch with the ERP71 team about pricing, onboarding or support.',
        type: 'website',
