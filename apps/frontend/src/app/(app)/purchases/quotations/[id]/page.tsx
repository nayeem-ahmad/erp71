                        ...
                        <tbody className="divide-y divide-gray-50">
                            {rfq.items.map((item) => (
                                <tr key={item.id}>
                                    ...
                                    <td className="py-3 text-end">{formatBDT(parseFloat(item.unit_cost), { locale })}</td>
                                    <td className="py-3 text-end font-bold">{formatBDT(parseFloat(item.line_total), { locale })}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
