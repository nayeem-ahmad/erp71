    ...
    return (
        <ModalShell size="lg" onBackdropClick={onClose}>
                ...
                <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
                    <div className="space-y-4 overflow-y-auto px-6 py-4">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-5">
                            ...
                            <div className="md:col-span-7 space-y-3.5">
                                <div>
                                    <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.productName}</label>
                                    <input
                                        required
                                        type="text"
                                        placeholder={t.addProductModal.placeholders.name}
                                        className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
                                        value={formData.name}
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">SKU</label>
                                        <input
                                            type="text"
                                            placeholder={t.addProductModal.placeholders.sku}
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-mono"
                                            value={formData.sku}
                                            onChange={(e) => setFormData({ ...formData, sku: e.target.value })}
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.salePrice}</label>
                                        <input
                                            required
                                            type="number"
                                            step="0.01"
                                            placeholder={t.addProductModal.placeholders.price}
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-bold"
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.brand}</label>
                                        <select
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
                                    ...
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.quantityUnit}</label>
                                        <select
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.group}</label>
                                        <select
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
                                    ...
                                    <div>
                                        <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.subgroup}</label>
                                        <select
                                            className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-medium"
                            ...
                            <div className="md:col-span-5 space-y-3.5">
                                <div className="flex gap-4 items-start">
                                    ...
                                    {/* Initial Stock & Featured Toggle */}
                                    <div className="flex-1 space-y-2">
                                        <div>
                                            <label className="block text-xs font-medium text-gray-500 mb-1 ml-1">{t.addProductModal.initialStock}</label>
                                            <input
                                                required={mode === 'create'}
                                                type="number"
                                                placeholder={t.addProductModal.placeholders.initialStock}
                                                disabled={mode === 'edit'}
                                                className="w-full bg-gray-50 border-none rounded-xl py-2 px-3 text-sm focus:ring-2 focus:ring-blue-500/10 transition-all font-bold disabled:opacity-50"
                                                value={formData.initialStock}
                                                onChange={(e) => setFormData({ ...formData, initialStock: e.target.value })}
                                            />
                                        </div>
                                        <div className="bg-blue-50/50 rounded-xl px-3 py-1.5 border border-blue-100/50 flex items-center h-8">
                                    ...
                                    <div className="grid grid-cols-3 gap-2">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-white border-none rounded-xl py-2 px-2 text-xs focus:ring-2 focus:ring-blue-500/10 transition-all font-bold text-center"
                    ...
                    <div className="border-t border-gray-100 px-6 py-3 flex space-x-3 bg-white">
                        <button
                            type="button"
                            onClick={onClose}
