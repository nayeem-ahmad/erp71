...
const SALES_HUB_SECTIONS: HubSectionConfig[] = [
    ...
    },
    {
        ...
        links: [
            ...
            { href: routes.sales.customerBadDebts, key: 'badDebts', icon: Ban, accent: 'bg-amber-50 text-amber-700 border-amber-100' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: routes.storefront.pages, key: 'storefrontPages', icon: FileText, accent: 'bg-primary-light text-primary border-primary-border' },
            { href: routes.storefront.menu, key: 'storefrontMenu', icon: Menu, accent: 'bg-primary-light text-primary border-primary-border' },
