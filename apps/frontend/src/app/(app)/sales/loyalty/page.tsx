        ...
        <PageShell>
                ...
                <div className="relative max-w-sm">
                    ...
                    <input
                        ...
                        className="w-full rounded-xl border border-gray-200 bg-white ps-9 pe-3.5 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
                    />
                </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                    ...
                    <div className="grid grid-cols-[1fr_140px_120px_140px_120px] gap-4 px-5 py-3 bg-gray-50 border-b border-gray-100">
                        ...
                        <span className="text-xs font-bold uppercase tracking-wider text-gray-400 text-end">{t.shared.columns.points}</span>
                        <span className="text-xs font-bold uppercase tracking-wider text-gray-400">{t.shared.columns.lastTransaction}</span>
                        <span className="text-xs font-bold uppercase tracking-wider text-gray-400 text-end">{t.shared.columns.actions}</span>
                    </div>
                                ...
                                return (
                                    <div key={customer.id}>
                                        ...
                                        <div className="grid grid-cols-[1fr_140px_120px_140px_120px] gap-4 px-5 py-3.5 items-center hover:bg-gray-50 transition-colors">
                                            ...
                                            <span className="text-sm font-bold text-purple-700 text-end">
                                                            ...
                                                            {detail.transactions.slice(0, 10).map((tx) => (
                                                                ...
                                                                >
                                                                    ...
                                                                    <div className="flex items-center gap-4 flex-shrink-0">
                                                                        ...
                                                                        <span className="text-xs text-gray-400 w-24 text-end">
