...
> **VPS production (`app.erp71.com`):** Postgres runs in Docker without PgBouncer. Use the internal `db:5432` URL in `.env.production`. The checklist below applies to Supabase/Render pooled connections only.
