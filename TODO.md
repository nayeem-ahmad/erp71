...
- [x] Shop owner demo data + clear data — `seedTenantDemoData` in `@erp71/database`; `POST /tenants/demo-data` + `DELETE /tenants/data?mode=transactions|all` (OWNER-only); `/settings/data` page with load-demo card and two clear-data confirmation dialogs (type "clear"/"clear all"); Database nav icon + i18n en/bn/ms — done 2026-07-03
