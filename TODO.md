...
- [x] Signup form input validation — client-side checks for password length, email format, and required fields with specific error messages; API client handles NestJS array message format; server error mapping for duplicate email; backend DTO validators given human-readable messages; i18n keys in en/bn/ms — done 2026-07-03
